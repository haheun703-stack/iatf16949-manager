...
export function TodoStrip({
  ...
  return (
    <div className="bg-card border border-border rounded-xl shadow-sm px-5 py-3 flex items-center gap-2.5 flex-wrap">
      ...
      {isEmpty && <span className="text-[11.5px] text-emerald-600 font-semibold">오늘 도래 항목 없음 ✓</span>}
      ...
      {topRed && (
        <Chip onClick={() => setPage('sq-readiness')}>
          ...
          <button
            ...
            className="text-[9.5px] font-extrabold px-2 py-[2px] rounded-full bg-sky-100 text-sky-700 border border-transparent hover:border-sky-500"
          >
            AI 초안 ›
          </button>
        </Chip>

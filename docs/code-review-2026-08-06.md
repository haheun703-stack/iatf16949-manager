...
| **P0** | C-3 최소방어 + M-2(sidecar 가드)·M-3(T4 취소 필터)·M-4(substr→localtime)·M-5(TOCTOU)·M-8(발번 연타) | 내일 오전 1배치 |
| P1 | M-1·M-6·M-7·M-9·M-10 + Minor 16 + confirm 일괄 교체·메뉴 이중 등재 | 내일~ (32호 1차분 5화면과 병행 — 같은 파일 순서 조율) |

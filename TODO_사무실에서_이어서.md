...
**▶ 남은 것**: ①관제탑 5팀 보드에 담당자(assignee) 실명 기입 — v4 STEP 2, §05 표의 담당자 공란
②SQ 대시보드 5팀 재집계 확인(생산기술 손실 → 생산팀 합산) ③이벤트 원장 조회("이 LOT 계보 보여줘")
앱 연결 — 사내망 웹 단계와 세트 ④§04 KPI 목표치 → kpi_indicators 확장(팀별 지표 대량) 검토.

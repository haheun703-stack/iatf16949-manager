...
const ADOPTED_SHEETS = {
  ...
  'M4200-01':
    "마스터 'AM_조도측정 체크시트(M4200-01)' 시트(변형 8종 중 AM) → templates/batch6/M4200-01_AM조도측정체크시트.xlsx (0113 정밀인발(인발) 첫 매치 매핑 = 검수회신_6배치 판정3 반전으로 교체, 0114 — AM 변형 우선 탐색 재발 2번째)",
...
const VIEW_ONLY = new Set([
  ...
  // 5배치(0112 — CFT 실명 분장표)
  'B2300-01',
  // 6배치(0113 — 기준표 3·이미지 절차/구역도 2·책자형 1·계약서/협정서 3(사용자 확정 선례)·서약서 1(판정 동반))
  'J3100-04', 'M1100-06', 'L3100-05', 'L3100-06', 'M4100-05',
  'A8101-01', 'K1100-07', 'K1100-08', 'K1100-09', 'A7100-01',
  // 7차 트랙(0118, 판정 2 실측 분기 — 쇼바 절차서 = 이미지 도해·품번별 기준서 = 문서관리 영역)
  'L2100-06', 'L2100-10'
])

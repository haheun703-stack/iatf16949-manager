...
const CASES = [
  ...
  {
    // 0114 반전 이행(260730): AM 시트 추출 채택 — 측정값 106공정(값 = 400+순번), 작성자 AN2
    code: 'M4200-01',
    values: (() => {
      const v = { 작성자: LOGIN }
      for (let i = 1; i <= 106; i++) v[`측정값${String(i).padStart(3, '0')}`] = String(400 + i)
      return v
    })(),
    expect: [
      ['O32', '401'], ['O50', '419'], ['AE32', '420'], ['AE50', '438'], ['AU32', '439'], ['AU50', '457'],
      ['O57', '458'], ['O75', '476'], ['AE57', '477'], ['AE75', '495'], ['AU57', '496'], ['AU67', '506'],
      ['AN2', LOGIN]
    ]
  },
  {

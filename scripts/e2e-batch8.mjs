...
const CASES = [
  ...
  },
  {
    code: 'K1200-01',
    values: {
      main: (() => { const r = Array.from({ length: 10 }, () => ({})); r[0] = { 등록일자: '2026-07-31', 업체명: '(주)대성정밀', 사업자번호: '123-45-67890', 주소: '부산시 강서구', 연락책임자: '김담당', 품목: '절단 가공품', iatf: '~2027-12', iso9001: '~2027-12' }; r[9] = { 업체명: '말행상사' }; return r })(),
      sub: [{ 대표자: '홍길동', 업종업태: '제조/금속가공', 연락처: 'TEL : 051-111-2222', 연락처2: '010-1234-5678' }]
    },
    expect: [['B6', '2026-07-31'], ['C6', '대성정밀'], ['D6', '123-45'], ['F6', '김담당'],
      ['H6', '~2027-12'], ['C24', '말행상사'], ['C7', '홍길동'], ['D7', '금속가공'], ['E7', '051-111']]
  },
  {
    code: 'K1200-02',
    values: {
      작성일자: '작성일자 : 2026-07-31', 작성자: '작성자 : 하헌',
      rows: (() => { const r = Array.from({ length: 18 }, () => ({})); r[0] = { 분류: '원자재', 업체명: '현대제철', 제품명: 'STKM11A 코일', 품번: '-', 품질리스크: '하', 납기리스크: '하', qms: 'IATF16949', 평가y1: 'A', 실적q1: 'A', 실적d1: 'A' }; r[17] = { 업체명: '말행상사' }; return r })()
    },
    expect: [['E3', '2026-07-31'], ['V3', '하헌'], ['A7', '원자재'], ['E7', '현대제철'],
      ['J7', 'STKM11A'], ['T7', '하'], ['Z7', 'IATF16949'], ['AE7', 'A'], ['AK7', 'A'], ['E24', '말행상사']]
  },
  {
    code: 'K1200-04',
    values: {
      회사명: '(주)대성정밀', 사업자번호: '123-45-67890', 대표자: '홍길동', 업종업태: '제조/금속가공',
      소재지본사: '부산시 강서구 녹산산단', 소재지공장: '동일', 소재지사무실: '동일', 설립일자: '2010년 3월 2일',
      형태법인: '법인 ( √ )', 자본금: '50,000', 거래처: [{ 거래처: '(주)태평양', 의존율: '60%', 품목: '절단 가공품' }],
      대지: '1,200', 건물: '800', 사무직: '5', 현장직: '22', 품질관리: '3', 총원: '30',
      경영방침: '품질 제일', 품질방침: '불량 제로', 전문기술력: '정밀 절단 15년',
      기타사항: '납기 준수율 99%', 조사결과: '등록 적합'
    },
    expect: [['F4', '대성정밀'], ['V4', '123-45'], ['F5', '홍길동'], ['F6', '녹산산단'],
      ['F9', '2010년'], ['Y9', '√'], ['F10', '50,000'], ['Q11', '태평양'], ['U11', '60%'],
      ['J11', '1,200'], ['J16', '30'], ['J17', '품질 제일'], ['J23', '정밀 절단'],
      ['F26', '99%'], ['F29', '등록 적합']]
  },
  {
    code: 'J1103-01',
    values: {
      품번: '25410-2R000', 품명: '토크로드 파이프', 차종: '2R000', 공정명: '자동절단', 설비명: 'AC-01', 작성일: '2026-07-31',
      cond: [{ 관리항목: '절단 속도', 조건: '1,200rpm', 확인방법: '설정치 확인', 주기: '시업 시', 도구: '패널', 담당: '작업자' }, {}, {}, {}, { 관리항목: '말행' }],
      insp: [{ 검사항목: '절단면 버', 판단기준: '버 없을 것', 확인방법: '육안', 주기: '2H', 도구: '-', 담당: '작업자' }],
      작업순서: '1. 소재 투입\n2. 절단\n3. 검사', 안전: '보호구 착용', 부적합절차: '작업 중지 → 반장 보고', 부적합유형: '치수 불량·버 과다',
      tools: [{ 공구명: '절단날', 규격: 'D350', 확인방법: '육안', 주기: '주 1회', 도구: '-' }],
      revs: [{ 개정일: '2026-07-31', 내용: '제정', 확인: '하헌' }]
    },
    expect: [['R1', '25410-2R000'], ['R2', '토크로드'], ['AC1', '자동절단'], ['AC2', 'AC-01'],
      ['C7', '절단 속도'], ['G7', '1,200rpm'], ['C11', '말행'], ['AA7', '절단면 버'], ['AE7', '버 없을'],
      ['A18', '소재 투입'], ['M18', '보호구'], ['Y18', '작업 중지'], ['AK18', '치수 불량'],
      ['C33', '절단날'], ['AA33', '2026-07-31'], ['AS33', '하헌']]
  },
  {
    code: 'D1100-01',
    values: {
      사고일시: '2026-07-30', 소속: '생산팀', 상해부위: '좌수 검지', 성명: '박작업', 사고장소: '3공장 절단',
      입사일자: '2020-05-11', 작업명: '소재 투입', 목격자: '이동료',
      발생경위: '소재 투입 중 협착', 원인분석: '안전 커버 미부착', 조치사항: '커버 설치·교육 실시'
    },
    expect: [['R5', '생산팀'], ['E6', '좌수 검지'], ['R6', '박작업'], ['E7', '3공장'],
      ['E8', '소재 투입'], ['R8', '이동료'], ['A10', '협착'], ['A24', '안전 커버'], ['A34', '커버 설치']]
  },
  {
    code: 'D1100-02',
    values: {
      제목: '( 2026 )년 사내 제품안전 교육 계획서', 작성일: '2026년 7월 31일', 작성부서: '품질보증팀',
      연도: '( 2026 )년', 계획6: '○', 실적6: '●', 계획12: '○', 특기사항: '전 사업부 확대'
    },
    expect: [['E1', '2026'], ['I3', '7월 31일'], ['W3', '품질보증팀'], ['M5', '( 2026 )'],
      ['AB7', '○'], ['AB8', '●'], ['AT7', '○'], ['E9', '전 사업부']]
  },
  {
    code: 'D1100-04',
    values: {
      제목: '정밀강관 사업부 공정 안전점검 연간 계획 / 실적', 연도: '2026년',
      rows: [{ 월1: '○', 월12: '○', 비고: '-' }, { 월1: '●' }, { 월1: '0' }, { 월1: '0' }, { 월1: '0' }]
    },
    expect: [['E1', '정밀강관'], ['H4', '2026년'], ['H6', '○'], ['AO6', '○'], ['AR6', '-'],
      ['H7', '●'], ['H8', '0'], ['H10', '0']]
  },
  {
    code: 'D1100-05',
    values: {
      제목: '정밀강관 사업부 공정 안전점검 체크시트', 점검일: '2026년 7월 31일', 점검자: '손진식 / 하헌',
      rows: (() => { const r = Array.from({ length: 30 }, () => ({})); r[0] = { 결과: '양호', 유효성: 'OK' }; r[29] = { 결과: '양호' }; return r })(),
      특기사항: '이상 없음'
    },
    expect: [['D1', '정밀강관'], ['G3', '7월 31일'], ['O3', '손진식'], ['Q5', '양호'], ['Y5', 'OK'],
      ['Q34', '양호'], ['B37', '이상 없음']]
  },
  {
    code: 'D1100-06',
    values: {
      제목: '정밀강관 사업부 공정 안전점검 개선대책', 개선부서: '생산팀', 담당정: '손진식', 담당부: '박작업',
      지적사항: '전선 피복 손상', 개선방안: '전선 교체·배선 정리', 점검일자: '2026-07-31', 개선완료일: '2026-08-07'
    },
    expect: [['A1', '정밀강관'], ['AN1', '생산팀'], ['AO2', '손진식'], ['AO3', '박작업'],
      ['A24', '전선 피복'], ['X24', '전선 교체']]
  },
  {
    code: 'L2200-01',
    values: {
      제목: '(2026)년 신뢰성 시험 계획서', 작성일자: '2026-07-31', 작성자: LOGIN,
      rows: (() => { const r = Array.from({ length: 18 }, () => ({})); r[0] = { 품번: '25410-2R000', 품명: '토크로드', 시험주기: '연 1회', 시험구분: '외주', 검사항목: '내구성', 월9: '○', 비고: '-' }; r[17] = { 품명: '말행' }; return r })()
    },
    expect: [['C1', '2026'], ['G5', LOGIN], ['B8', '25410-2R000'], ['D8', '토크로드'], ['F8', '외주'],
      ['G8', '내구성'], ['P8', '○'], ['D25', '말행']]
  },
  {
    code: 'L2300-01',
    values: {
      main: (() => { const r = Array.from({ length: 5 }, () => ({})); r[0] = { 관리번호: 'LS-001', 차종: '2R000', 품명: '토크로드 외관', 품질특성: '용접 비드 한도', 교체주기: '1년', 등록일자: '2026-07-31' }; r[4] = { 관리번호: '말행' }; return r })(),
      appr: [{ 등록승인: '김기범' }],
      disp: [{ 폐기일자: '-', 폐기사유: '-' }]
    },
    expect: [['C8', 'LS-001'], ['H8', '2R000'], ['P8', '용접 비드'], ['X8', '1년'], ['AB8', '2026-07-31'],
      ['C20', '말행'], ['AB9', '김기범'], ['AB10', '-']]
  },
  {
    code: 'J3100-03',
    values: {
      rows: (() => { const r = Array.from({ length: 12 }, () => ({})); r[0] = { 요청자: '손진식', 의뢰일자: '2026-07-31', 차종: '2R000', 품번: '25410-2R000', 품명: '토크로드', 변경유형: '설비', 변경내용: '절단기 교체', 변경사유: '노후', 공정명: '절단', 작업표준서: '○', 판정: '적합' }; r[11] = { 변경내용: '말행' }; return r })()
    },
    expect: [['B6', '손진식'], ['D6', '2R000'], ['E6', '25410-2R000'], ['H6', '설비'],
      ['I6', '절단기 교체'], ['K6', '절단'], ['L6', '○'], ['AA6', '적합'], ['I17', '말행']]
  },
  {
    code: 'F1100-02',
    values: {
      작성일자: '  작성일자 : 2026년 7월 31일', 과정명: 'IATF16949 내부심사원', 소속직위: '품질보증팀/차장', 성명: '김기범',
      교육장소: '부산상공회의소', 교육기관: 'KSA', 교육비: '450,000', 교육기간: '7/22~7/24', 이수시간: '24H',
      교육구분: '비합숙', 교육명: 'IATF16949 내부심사원 양성과정', 교육목적: '내부심사 역량 확보',
      적용성: '■크게 도움', 도입여부: '■적극적인 도입 요망', 전달일자: '2026년 8월 7일', 전달대상: '품질보증팀 전원'
    },
    expect: [['A3', '7월 31일'], ['E4', '내부심사원'], ['P4', '차장'], ['AA4', '김기범'],
      ['E5', '상공회의소'], ['P5', 'KSA'], ['AA5', '450,000'], ['E6', '7/22'], ['P6', '24H'],
      ['A8', '양성과정'], ['A10', '역량 확보'], ['D30', '■크게 도움'], ['P30', '■적극적인'],
      ['I32', '8월 7일'], ['I33', '전원']]
  },
  {
    code: 'F1100-05',
    values: {
      rows: (() => { const r = Array.from({ length: 17 }, () => ({})); r[0] = { 교육일자: '2026-07-31', 교육명: '제품 안전교육', 관리자: '김기범(차장/품질)', 작업자: '박작업 외 11' }; r[16] = { 교육명: '말행 교육' }; return r })()
    },
    expect: [['E8', '제품 안전교육'], ['N8', '김기범'], ['Z8', '박작업'], ['E24', '말행 교육']]
  },
  {
    code: 'F1100-06',
    values: {
      작성일자: '작성일자 : 2026-07-31', 작성자: '작성자 : 하헌', 교육명: '제품 안전(PSCR) 교육',
      구분: '■사내교육     □사외교육', 교육강사: '김기범', 교육일자: '2026-07-31', 교육장소: '2공장 회의실',
      교육대상: '생산·품질 전원', 교육인원: '27명', 교육내용: 'PSCR 항목·안전 특성 관리'
    },
    expect: [['A3', '2026-07-31'], ['O3', '하헌'], ['F4', 'PSCR'], ['X4', '■사내교육'],
      ['X5', '김기범'], ['F6', '2026-07-31'], ['X6', '2공장'], ['F7', '전원'], ['X7', '27명'], ['A9', '안전 특성']]
  }
]
